...
public class PAItemRegistry {
    ...
    public static final RegistryObject<IgnisSpellHologram> IGNIS_SPELL_HOLOGRAM = ITEMS.register(IgnisSpellHologram.ITEM_NAME, () -> new IgnisSpellHologram(new Item.Properties(), new SpellData(new IgnisFireball())));
