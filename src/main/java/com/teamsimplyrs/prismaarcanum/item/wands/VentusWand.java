...
public class VentusWand extends AbstractWand implements ICastingItem {

    public static final String ITEM_NAME = "ventus_wand_tier1";

    public static final Properties ITEM_PROPERTIES = new Properties();

    public static List<SpellBase> listSpellsIgnis = new ArrayList<>();

    public final String WAND_ELEMENT = "ventus";
