...
public class FireballProjectileModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.offset(0.0F, 0F, 0.0F));
		...
		PartDefinition outer = body.addOrReplaceChild("outer", CubeListBuilder.create().texOffs(3, 9).addBox(0.25F, -2.375F, 0.25F, 2.25F, 2.25F, 2.25F, new CubeDeformation(0.0F))
				...
				.texOffs(3, 9).addBox(0.25F, 0.125F, -2.5F, 2.25F, 2.25F, 2.25F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.125F, 0.0F));
	...
	public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch) {
		...
		this.animate(((FireballProjectile)pEntity).FIREBALL_ANIM_STATE, PAAnimationDefinitions.INNER_ANIMATION, pAgeInTicks, 1.0F);
	}
}